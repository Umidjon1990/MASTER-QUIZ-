...
import { pgTable, text, varchar, integer, boolean, timestamp, jsonb, index, uniqueIndex, customType } from "drizzle-orm/pg-core";
...
export const libraryFileBlobs = pgTable("library_file_blobs", {
